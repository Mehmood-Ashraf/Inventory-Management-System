...
const CustomerSlip = forwardRef(({ formData }, ref) => {
  return (
    <div ref={ref} className="p-3 text-sm bg-white print-margin-fix" style={{width: '80mm', margin: '0 auto'}}>
      <div className="flex justify-center items-center" style={{ padding : 0, margin : 0}}>
        <img src="/download.png" alt="A-Z logo" className="w-16 h-16" style={{padding : 0, margin : 0}}/>
      </div>
      <p>Date: {formData.date ? new Date(formData?.date).toLocaleDateString("en-GB") : "N/A"}</p>
